                              ...
                              builder: (context, value, child) => Flexible(
                                child: Padding(
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    onChanged: value.onChangedCurrentLocation,
                                  ),
                                ),
                              ),
                            ),
                        ...
                        children: [
                          Flexible(
                            ...
                            child: CustomSelector(
                                    ...
                                    chosenValue: value.possessionChosenValue)
                                .use(),
                          ),
                          const Spacer(flex: 1),
                          Flexible(
                            ...
                            child: CustomSelector(
                                    ...
                                    isPrefixIcon: true,
                                    prefixIcon: Image.asset('assets/sort.png',
                                        height: 15, width: 10),
                                    textColor: Colors.white.withOpacity(0.8),
                                    color: CustomColors.dark,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text('Office (1200 Sq.feets)',
                                  style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                      fontSize: 16,
                                      color: Colors.white,
                                  ...
                                  Row(
                                    children: const [
                                      Icon(Icons.currency_rupee_rounded,
                                          color: Color(0xFF2AB0E4), size: 17),
                                      Text(
                                        '12,50,000',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w400,
